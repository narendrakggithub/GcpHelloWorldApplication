...
public class UserRepositoryImpl implements UserRepository {
	...
	public int insert(User user) {
		...
		return jdbcTemplate.update(sqlQuery, user.getFirstName(), user.getLastName(), user.getEmail());
	}
	...
	public int update(User user) {
		...
		return jdbcTemplate.update(sqlQuery, user.getFirstName(), user.getLastName(), user.getEmail(), user.getId());
	}
